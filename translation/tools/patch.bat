...
.BrowseForFolder(0,'Wartales directory not found. Please select the directory where Wartales is installed.',0,0).self.path"" || goto :error

IF NOT EXIST "%WARTALE_HOME%" (
  echo Could not find Wartales directory. Please select the directory where Wartales is installed at the prompt.
